<template>
  <div class="infoMent">
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="adress" label="家庭住址" align="center">
      </el-table-column>
    ...
    <el-dialog :title="state ? '添加学生信息' : '修改学生信息'" :visible.sync="dialogFormVisible" width="500px">
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-form-item label="家庭住址" :label-width="formLabelWidth" prop="adress">
...
// import { VariantAlsoNegotiates } from 'http-errors'
export default {
  data() {
    return {
      tableData: [],
