<!-- <template>
    <div class="notfound">
        <div class="wrapper">
            ...
            <div>首页悄悄，点击<router-link to="/">这里</router-link>进入首页</div>
        </div>
    </div>
</template>
...
.notfound {
    height: 100%;
    background-image: url('../assets/star.jpg'), url('../assets/astronauta.jpg');
